...
public class Asset {
  ...
  public Asset publicUrl(String publicUrl) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Asset asset = (Asset) o;
    return Objects.equals(this.publicUrl, asset.publicUrl) &&
        Objects.equals(this.source, asset.source) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(publicUrl, source, type, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("publicUrl").isJsonNull() && (jsonObj.get("publicUrl") != null && !jsonObj.get("publicUrl").isJsonNull()) && !jsonObj.get("publicUrl").isJsonPrimitive()) {
