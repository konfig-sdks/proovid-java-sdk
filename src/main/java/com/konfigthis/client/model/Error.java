...
public class Error {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Error error = (Error) o;
    return Objects.equals(this.service, error.service) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(service, key, message, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("service").isJsonNull() && (jsonObj.get("service") != null && !jsonObj.get("service").isJsonNull()) && !jsonObj.get("service").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `service` to be a primitive type in the JSON string but got `%s`", jsonObj.get("service").toString()));
      }
      if (!jsonObj.get("key").isJsonNull() && (jsonObj.get("key") != null && !jsonObj.get("key").isJsonNull()) && !jsonObj.get("key").isJsonPrimitive()) {
