...
public class SumSubAmlVerificationHitResponse {
  ...
  public SumSubAmlVerificationHitResponse() {
  }

  public SumSubAmlVerificationHitResponse dataSourceName(String dataSourceName) {
  ...
  **/
  ...
  public SumSubAmlVerificationHitResponse categories(List<String> categories) {
  ...
  public SumSubAmlVerificationHitResponse addCategoriesItem(String categoriesItem) {
  ...
  **/
  ...
  public SumSubAmlVerificationHitResponse name(String name) {
  ...
  **/
  ...
  public SumSubAmlVerificationHitResponse country(String country) {
  ...
  **/
  ...
  public SumSubAmlVerificationHitResponse politicalPositions(List<String> politicalPositions) {
  ...
  public SumSubAmlVerificationHitResponse addPoliticalPositionsItem(String politicalPositionsItem) {
  ...
  **/
  ...
  public SumSubAmlVerificationHitResponse relatedUrls(List<String> relatedUrls) {
  ...
  public SumSubAmlVerificationHitResponse addRelatedUrlsItem(String relatedUrlsItem) {
  ...
  **/
  ...
  public SumSubAmlVerificationHitResponse birthDates(List<String> birthDates) {
  ...
  public SumSubAmlVerificationHitResponse addBirthDatesItem(String birthDatesItem) {
  ...
  **/
  ...
  public SumSubAmlVerificationHitResponse matchTypes(List<String> matchTypes) {
  ...
  public SumSubAmlVerificationHitResponse addMatchTypesItem(String matchTypesItem) {
  ...
  **/
  ...
  public SumSubAmlVerificationHitResponse matchStatus(String matchStatus) {
  ...
  **/
   ...
   * @return the SumSubAmlVerificationHitResponse instance itself
   */
  public SumSubAmlVerificationHitResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SumSubAmlVerificationHitResponse sumSubAmlVerificationHitResponse = (SumSubAmlVerificationHitResponse) o;
    return Objects.equals(this.dataSourceName, sumSubAmlVerificationHitResponse.dataSourceName) &&
        Objects.equals(this.categories, sumSubAmlVerificationHitResponse.categories) &&
        Objects.equals(this.name, sumSubAmlVerificationHitResponse.name) &&
        Objects.equals(this.country, sumSubAmlVerificationHitResponse.country) &&
        Objects.equals(this.politicalPositions, sumSubAmlVerificationHitResponse.politicalPositions) &&
        Objects.equals(this.relatedUrls, sumSubAmlVerificationHitResponse.relatedUrls) &&
        Objects.equals(this.birthDates, sumSubAmlVerificationHitResponse.birthDates) &&
        Objects.equals(this.matchTypes, sumSubAmlVerificationHitResponse.matchTypes) &&
        Objects.equals(this.matchStatus, sumSubAmlVerificationHitResponse.matchStatus)&&
        Objects.equals(this.additionalProperties, sumSubAmlVerificationHitResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SumSubAmlVerificationHitResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SumSubAmlVerificationHitResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SumSubAmlVerificationHitResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SumSubAmlVerificationHitResponse is not found in the empty JSON string", SumSubAmlVerificationHitResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SumSubAmlVerificationHitResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SumSubAmlVerificationHitResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SumSubAmlVerificationHitResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SumSubAmlVerificationHitResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SumSubAmlVerificationHitResponse>() {
           @Override
           public void write(JsonWriter out, SumSubAmlVerificationHitResponse value) throws IOException {
           ...
           @Override
           public SumSubAmlVerificationHitResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SumSubAmlVerificationHitResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SumSubAmlVerificationHitResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SumSubAmlVerificationHitResponse
  * @throws IOException if the JSON string is invalid with respect to SumSubAmlVerificationHitResponse
  */
  public static SumSubAmlVerificationHitResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SumSubAmlVerificationHitResponse.class);
  }

 /**
  * Convert an instance of SumSubAmlVerificationHitResponse to an JSON string
  *
  * @return JSON string
  */
