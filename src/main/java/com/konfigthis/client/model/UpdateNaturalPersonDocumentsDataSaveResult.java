...
public class UpdateNaturalPersonDocumentsDataSaveResult {
  ...
  public UpdateNaturalPersonDocumentsDataSaveResult() {
  }
  ...
  public UpdateNaturalPersonDocumentsDataSaveResult idDocumentSaved(BaseResponse idDocumentSaved) {
  ...
  **/
  ...
  public UpdateNaturalPersonDocumentsDataSaveResult faceSaved(BaseResponse faceSaved) {
  ...
  **/
  ...
  public UpdateNaturalPersonDocumentsDataSaveResult livenessCheckURL(StringBaseResponse livenessCheckURL) {
  ...
  **/
  ...
  public UpdateNaturalPersonDocumentsDataSaveResult addressDocumentSaved(BaseResponse addressDocumentSaved) {
  ...
  **/
  ...
  public UpdateNaturalPersonDocumentsDataSaveResult verificationStarted(BaseResponse verificationStarted) {
  ...
  **/
   ...
   * @return the UpdateNaturalPersonDocumentsDataSaveResult instance itself
   */
  public UpdateNaturalPersonDocumentsDataSaveResult putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateNaturalPersonDocumentsDataSaveResult updateNaturalPersonDocumentsDataSaveResult = (UpdateNaturalPersonDocumentsDataSaveResult) o;
    return Objects.equals(this.idDocumentSaved, updateNaturalPersonDocumentsDataSaveResult.idDocumentSaved) &&
        Objects.equals(this.faceSaved, updateNaturalPersonDocumentsDataSaveResult.faceSaved) &&
        Objects.equals(this.livenessCheckURL, updateNaturalPersonDocumentsDataSaveResult.livenessCheckURL) &&
        Objects.equals(this.addressDocumentSaved, updateNaturalPersonDocumentsDataSaveResult.addressDocumentSaved) &&
        Objects.equals(this.verificationStarted, updateNaturalPersonDocumentsDataSaveResult.verificationStarted) &&
        Objects.equals(this.allSucceeded, updateNaturalPersonDocumentsDataSaveResult.allSucceeded)&&
        Objects.equals(this.additionalProperties, updateNaturalPersonDocumentsDataSaveResult.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(idDocumentSaved, faceSaved, livenessCheckURL, addressDocumentSaved, verificationStarted, allSucceeded, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateNaturalPersonDocumentsDataSaveResult {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateNaturalPersonDocumentsDataSaveResult
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateNaturalPersonDocumentsDataSaveResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateNaturalPersonDocumentsDataSaveResult is not found in the empty JSON string", UpdateNaturalPersonDocumentsDataSaveResult.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNaturalPersonDocumentsDataSaveResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNaturalPersonDocumentsDataSaveResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNaturalPersonDocumentsDataSaveResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNaturalPersonDocumentsDataSaveResult.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNaturalPersonDocumentsDataSaveResult>() {
           @Override
           public void write(JsonWriter out, UpdateNaturalPersonDocumentsDataSaveResult value) throws IOException {
           ...
           @Override
           public UpdateNaturalPersonDocumentsDataSaveResult read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateNaturalPersonDocumentsDataSaveResult instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateNaturalPersonDocumentsDataSaveResult given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateNaturalPersonDocumentsDataSaveResult
  * @throws IOException if the JSON string is invalid with respect to UpdateNaturalPersonDocumentsDataSaveResult
  */
  public static UpdateNaturalPersonDocumentsDataSaveResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNaturalPersonDocumentsDataSaveResult.class);
  }

 /**
  * Convert an instance of UpdateNaturalPersonDocumentsDataSaveResult to an JSON string
  *
  * @return JSON string
  */
