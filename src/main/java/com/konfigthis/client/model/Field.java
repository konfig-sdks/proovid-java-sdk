...
public class Field {
  ...
  **/
  ...
  public Field source(String source) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, field.value) &&
        ...
        Objects.equals(this.tag, field.tag)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(value, source, tag, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("tag").isJsonNull() && (jsonObj.get("tag") != null && !jsonObj.get("tag").isJsonNull()) && !jsonObj.get("tag").isJsonPrimitive()) {
