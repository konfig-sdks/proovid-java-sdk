...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://proovidapi.azurewebsites.net";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        if (configuration != null) {
            if (configuration.bearer != null) {
                this.setBearer(configuration.bearer);
            }
    ...
    public String getBearer() {
        return ((ApiKeyAuth) this.getAuthentication("Bearer")).getApiKey();
    }

    public void setBearer(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("Bearer")).setApiKey(apiKey);
    }

    public void setBearerPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("Bearer")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://proovidapi.azurewebsites.net)
